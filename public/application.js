...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateNewButton = function onCreateNewButton(event) {
	...
	var onCreateProduct = function onCreateProduct(event) {
	  ...
	  api.createProduct(data).then(ui.createProductSuccess)
	  // .then(function() {
	  //   onViewProducts();
	  // })
	  .catch(ui.failure);
	...
	var onDeleteProduct = function onDeleteProduct(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.deleteProduct(data).then(ui.deleteProductSuccess).catch(ui.deleteFailure);
	};
	...
	var onUpdateProduct = function onUpdateProduct(event) {
	  ...
	  var data = getFormFields(event.target);
	  // data.product.user_id = store.user.id;
	  api.updateProduct(data).then(ui.updateProductSuccess).catch(ui.updateFailure);
	};

	var onViewProducts = function onViewProducts(event) {
	  event.preventDefault();
	  api.viewAllProducts().then(ui.viewAllSuccess).then(function () {
	    $('#new-prod').off();
	    $('#create-form').off();
	    $('.updateProduct').off();
	    $('.deleteProduct').off();
	...
	module.exports = {
	  ...
	  onCreateNewButton: onCreateNewButton,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var viewAllProducts = function viewAllProducts(data) {
	  var request = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var viewAllProductsTemplate = __webpack_require__(15);
	...
	// };
	//
	var updateProductSuccess = function updateProductSuccess() {
	...
	//;
	var deleteProductSuccess = function deleteProductSuccess() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.editable : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    <ul class=handlebars-body>\n"
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.program(2, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.price : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.before_photo_link : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(2, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.after_photo_url : stack1),{"name":"if","hash":{},"fn":container.program(12, data, 0, blockParams),"inverse":container.program(2, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "      <hr>\n"
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.editable : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </ul>\n    <hr>\n";
	  ...
	  return "        <h4 id=\"product-description\">Product Description: "
	  ...
	  return "        <h5>Price $: "
	    ...
	    return "        <h5>Price: No Price Listed</h5>\n";
	},"10":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "        <h5 class=\"modal-photos\">Before-Photo Link: "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.before_photo_url : stack1), depth0))
	    + "</h5>\n";
	},"12":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "        <h5 class=\"modal-photos\">After-Photo Link: "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.after_photo_url : stack1), depth0))
	    + "</h5>\n";
	},"14":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, helper, alias1=container.lambda, alias2=container.escapeExpression;

	  return "        <form class=\"updateProduct\">\n          <fieldset>\n            <input type=\"hidden\" name=\"product[id]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" placeholder=\"Product ID\"> Edit Product Description: <input type=\"text\" name=\"product[description]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.description : stack1), depth0))
	    + "\" placeholder=\"New Description\">\n            <hr> Edit Before Photo: <input type=\"text\" name=\"product[before_photo_url]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.before_photo_url : stack1), depth0))
	    + "\" placeholder=\"Before Photo\">\n            <hr> Edit Price $: <input type=\"text\" name=\"product[price]\" $ value=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.price : stack1), depth0))
	    + "\" placeholder=\"Price\">\n            <hr> Edit After Photo: <input type=\"text\" name=\"product[after_photo_url]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.after_photo_url : stack1), depth0))
	    + "\" placeholder=\"After Photo\">\n            <hr>\n            <input type=\"submit\" value=\"Edit Project\" id=\"update-submit\">\n          </fieldset>\n        </form>\n        <form class=\"deleteProduct\" id=\"delete-form\">\n          <fieldset>\n            <input type=\"hidden\" name=\"product[id]\" value=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\">\n            <input type=\"submit\" name=\"submit\" value=\"Delete\" class=\"delete-product btn\" id=\"delete-button\">\n          </fieldset>\n        </form>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div id=\"template-title\">VIEW PROJECTS</div>\n<hr>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "cd1a24180fed679c7c8434f4e85eb6d8.jpg";

/***/ },
/* 41 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "81aab146207cdafa2b99a966d0ac6f62.jpg";

/***/ },
/* 42 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "859657d7fde8c0019871ea87048ff747.jpg";

/***/ },
/* 43 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "d990b42e0f51467b7281f3514a4a0874.png";

/***/ },
/* 44 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "3e3db9c13fc388abe988ea8d5e848fce.jpg";

/***/ },
/* 45 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "1c10a2682c9015941dfc98ba86b3082c.jpg";
